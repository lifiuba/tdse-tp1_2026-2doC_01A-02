...
* **Event (Trigger/Signal Input):** `EV_SYS_NAME` (Señales recibidas desde el módulo Sensor)
* **Signal (Output):** `EV_ACT_NAME` (Señales enviadas al módulo Actuator)
* **State:** `ST_SYS_NAME`
* **Timer:** `tick` / `DEL_SYS_NAME`
